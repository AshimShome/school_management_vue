        ...
        <div class="card">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <h3 class="card-title">{{ $t("create_new_teacher") }}</h3>
                            ...
                            <div class="col-mb-6">
                                <div class="form-group row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <base-input :form="teacherForm" field="name" v-model="teacherForm.name"></base-input>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <has-error :form="teacherForm" field="joining_date" class="d-block"></has-error>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-6 mb-3">
...
export default {
    ...
    methods: {
        setDate(event) {
            ...
            this.teacherForm.joining_date = formatTime;
        },
        ...
        async addTeacher() {
            try {
                const response = await this.teacherForm.post("/api/teachers", {
                    transformRequest: [
        ...
        async dataExistsChecking() {
            if (!this.departments.length) {
                this.toastWarning("Please create department first");
